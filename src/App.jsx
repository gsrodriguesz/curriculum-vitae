                    ...
                    <div className="flex justify-between items-start">
                        <div className="w-full">
                            ...
                            <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm md:text-base text-gray-400 font-medium mb-10">
                                ...
                                <a href="mailto:gustavoluizdsrodriguez@gmail.com" className="flex items-center gap-2 hover:text-white">
                                ...
                                <a href="tel:+5511995095240" className="flex items-center gap-2 hover:text-white">
